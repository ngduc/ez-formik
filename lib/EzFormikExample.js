...
var default_1 = /** @class */ (function (_super) {
    ...
    function default_1() {
        ...
        _this.renderForm = function (props) { return (React.createElement(EzForm_1["default"], { use: "spectre" },
            ...
            genders.map(function (gender) { return React.createElement(EzField_1["default"], { radio: true, value: gender.value },
                gender.label,
                " | gender"); }),
            React.createElement(EzField_1["default"], { component: "select", label: "Favorite Animal", name: "animal" }, animals.map(function (opt) { return React.createElement("option", { value: opt.value }, opt.label); })),
    ...
    default_1.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(formik_1.Formik, { initialValues: { email: 'example@email.com', roles: ['USER'], gender: '' }, validationSchema: schema, onSubmit: this.onSubmit, render: this.renderForm }),
