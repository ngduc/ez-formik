...
var EzFieldComp = function (props) {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(formik_1.FastField, { name: fieldName, placeholder: placeholder, onChange: props.formik.handleChange, validate: props.validate, className: "ez-field " + (hasErrors ? 'error-field' : '') }),
